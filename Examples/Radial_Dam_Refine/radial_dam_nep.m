function radial_dam_nep
%% Shallow water Radial Dam Break
%--------------------------------------------------------------------------
...
subplot(1,2,1);
showsolution(node,elem,Q(:,1)); view(45,20); zlim([0. 1.]);
xlabel('x'); ylabel('y'); zlabel('h')
subplot(1,2,2);
showsolution(node,elem,Q(:,2)); view(-45,20); zlim([-1. 1.]);
...
subplot(1,2,1);
showsolution(node,elem,h); view(45,20); zlim([0. 1.]);
xlabel('x'); ylabel('y'); zlabel('Stage');

subplot(1,2,2);
showsolution(node,elem,uh/max(abs(uh))); view(-45,20); zlim([-1. 1.]);
...
subplot(1,2,1);
showsolution(node,elem,abs(NEP)); view(45,20);
